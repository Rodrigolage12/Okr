...
import { LogOut, Target, Calendar, TrendingUp, FileText } from "lucide-react"
import { ClientProcessSection } from "@/components/client/client-process-section"
...
import { ClientReportsSection } from "@/components/client/client-reports-section"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Meu Portal</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="process" className="space-y-6">
            <ClientProcessSection userId={user.id} />
          </TabsContent>
          ...
          <TabsContent value="reports" className="space-y-6">
            <ClientReportsSection userId={user.id} />
          </TabsContent>
