...
import { Plus, Edit2, Trash2, CheckSquare, Filter } from "lucide-react"
...
export function AdminTasksSection() {
  ...
  const filteredTasks = selectedClient === "all" ? tasks : tasks.filter((task) => task.clientId === selectedClient)

  const addTask = () => {
    if (newTaskTitle.trim() && selectedClient !== "all") {
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex space-x-2">
            ...
            <Button
              onClick={addTask}
              disabled={!newTaskTitle.trim() || selectedClient === "all"}
          ...
          {selectedClient === "all" && (
            <p className="text-sm text-gray-500 mt-2">Selecione um cliente específico para adicionar tarefas</p>
          )}
        </CardContent>
      </Card>
              ...
              {pendingTasks.map((task) => (
                <div key={task.id} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600 mt-1">Cliente: {task.clientName}</p>
              ...
              {completedTasks.map((task) => (
                <div key={task.id} className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg opacity-75">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600 mt-1 line-through">Cliente: {task.clientName}</p>
          ...
          <Card>
            <CardContent className="text-center py-8">
              ...
              <p className="text-sm text-gray-400">
                {selectedClient === "all"
                  ? "Selecione um cliente para ver suas tarefas"
                  : "Este cliente ainda não possui tarefas"}
              </p>
            </CardContent>
          </Card>
        )}
